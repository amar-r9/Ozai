...
public interface ClientService {
	...
	public List<GateRequests> getGateRequests(int client_code, String status, int i);

	public GateRequests getGateRequestDetails(int id);

	public boolean approveGateRequest(int requestId);

	public List<GateRequests> getUserGateRequests(int user_id, String status, int i);
