...
<html dir="ltr" lang="en">
  <head>
    ...
    <meta
      name="description"
      content="Ticket details page contains ticket raised for the issue and it's status."
    />
						...
						<div class="row">
							<div class="card" style="border-radius: 20px;">
								<div class="card-body">
									...
									<div class="row">
										<div class="col-6">
											<p style="font-weight: 800; color: #000;">Room : ${ticket.bdetails.room.room_no }</p>
										</div>
										<div class="col-6">
									...
									<c:if test="${not empty ticket.filename}">
									    <script>
									        var filename = "${ticket.filename}";
									        var extension = filename.substring(filename.lastIndexOf('.') + 1).toLowerCase();
									
									        if (['png', 'jpeg', 'gif', 'jpg'].includes(extension)) {
									            document.write('<img src="https://ozailiving.com/uploaded_files/DOC/TICKET/' + filename + '" alt="ticket image" style="width: 100%;" />');
									        } else if (['mp4', 'webm', 'ogg'].includes(extension)) {
									            document.write('<video controls style="width: 100%;"><source src="https://ozailiving.com/uploaded_files/DOC/TICKET/' + filename + '" type="video/' + extension + '">Your browser does not support the video tag.</video>');
									        } else if (['mp3', 'wav', 'ogg'].includes(extension)) {
									            document.write('<audio controls style="width: 100%;"><source src="https://ozailiving.com/uploaded_files/DOC/TICKET/' + filename + '" type="audio/' + extension + '">Your browser does not support the audio element.</audio>');
									        } else {
									            document.write('<p>Unsupported file type: ' + extension + '</p>');
									        }
									    </script>
									</c:if>
								</div>
