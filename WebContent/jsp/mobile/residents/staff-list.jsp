										...
										<div class="row">
											<div class="col-3">
												<div class="card text-center m-0 p-0">
													<div class="p-1">
														<figure class="avatar avatar-44 m-0 p-0">
															<img
											...
											<div class="col-6 m-0 p-0">
												<p><span class="admin-name">${s.name }</span><br> <small
														class="text-secondary"><b>${s.designation }</b> ,<i
														class="nav-icon bi bi-building text-info"></i> <span class="admin-unit">${s.property.name }</span>
													</small>
												</p>
											</div>
