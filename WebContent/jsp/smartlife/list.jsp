...
<title>Smart Idol Registrations | Ozai</title>
<link rel="canonical"
...
<body>
	...
	<div id="main-wrapper">
		...
		<!-- Page wrapper  -->
		<!-- ============================================================== -->
		<div class="page-wrapper  pt-4" style="margin-top: 120px !important;">
			...
			<div class="container-fluid ">
				...
				<div class="row">
					<div class="col-12">
						<div class="card">						
							<h5 class="card-header text-center text-dark fw-bold">REGISTRATIONS</h5>						
							<div class="card-body text-center">
								<c:choose>
									<c:when test="${not empty users }">
										<table id="tenants" class="table customize-table mb-0 v-middle no-wrap align-items-stretch text-center">
											<thead>
												<tr>
													<th>SNo</th>
													<th>Name</th>
