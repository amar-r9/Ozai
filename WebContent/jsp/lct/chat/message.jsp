...
<body>
										...
										<c:when test="${message.sent_by eq 'User' }">
											<li class="mt-4">
												...
												<div class="chat-content ps-3 d-inline-block">
													<h5 class="text-muted fs-3 font-weight-medium">${message.details.user.name }</h5>
	...
	<script>
		...
		function saveMessage() {
			...
			$.ajax({
				type : "POST",
				url : "${pageContext.request.contextPath}/lct/${type}/send-message",
				data : formData,
				timeout : 100000,
		...
		<script>
			...
			function getRealData() {
				$.ajax({
			    	url: "${pageContext.request.contextPath}/lct/chat/${type}/getMessages/${id}",
			        type: "GET",
			        timeout : 100000,
					beforeSend:function(){
