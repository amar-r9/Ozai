  ...
  <body>
    ...
    <div id="main-wrapper">
      ...
      <div class="page-wrapper" style="margin-top: 50px;">
        ...
        <!-- ============================================================== -->
        <a href="<%=request.getContextPath() %>/lct/staff/list" class="btn btn-warning btn-sm btn-rounded"
        	style="position: fixed; z-index: 10; top: 300px; right: 10px;
		    width: fit-content;"><i class="fa fa-list"></i> &nbsp;STAFF LIST</a>
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 text-center">
              <h5 class="text-dark fw-bold">ADD STAFF</h5>
            </div>
                ...
                <div class="card-body">
                	<c:choose>
                		<c:when test="${ClientUser.access_level eq 1 }">
		                  	<form action="#"
								id="staff-form" method="post" modelAttribute="staff">
								<div class="row">
						...
						<c:otherwise>
							<div class="alert alert-warning">
								<h4>Only Head office can add/edit admin staff</h4>
							</div>
						</c:otherwise>
					</c:choose>
                </div>
    ...
    <script type="text/javascript">
	    function saveStaff() {
			var formData = $("#staff-form").serialize();
			$.ajax({
				type : "POST",
				url : "${pageContext.request.contextPath}/lct/addStaff",
				data : formData,
