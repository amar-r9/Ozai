					...
					<div class="col-9 col-md-9 col-sm-12 col-12">
						<div class="card">
							<div class="card-body">
								<!-- Download Template -->
						        <div>
						            <a href="downloadTemplate" class="btn btn-primary">Download Template</a>
						        </div>
						        
						        <!-- Upload File -->
						        <form action="uploadResidents" method="post" enctype="multipart/form-data" class="mt-4">
						            <div class="mb-3">
						                <label for="file" class="form-label">Upload Residents File (Excel/CSV)</label>
