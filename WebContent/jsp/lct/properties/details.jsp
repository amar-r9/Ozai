			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-9 col-md-9 col-sm-12 col-12">
					    ...
					    <%-- Iterate over the list and count available and occupied beds --%>
                        ...
                        <div class="row mb-2">
					        <div class="col-6">
					            <div class="p-2 text-center" style="background: #180055; border-radius: 10px;">
					                <div class="fw-bold text-white">Beds occupied <c:out value="${occupiedCount}" /></div>
					            </div>
					        </div>
					        <div class="col-6">
					            <div class="p-2 text-center" style="background: #180055; border-radius: 10px;">
					                <div class="fw-bold text-white">Beds available <c:out value="${availableCount}" /></div>
					            </div>
					        </div>
					    </div>
						<div class="card">
