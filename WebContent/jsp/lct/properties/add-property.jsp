			...
			<div class="page-breadcrumb">
				<div class="row">
					<div class="col-12 align-self-center">
						<h5 class="fw-bold text-dark">Add Property</h5>
					</div>
				</div>
			</div>
			<!-- ============================================================== -->
					...
					<div class="col-12">
						<div class="row">
							<div class="card">
								<div class="card-body">
									<c:choose>
										<c:when test="${ClientUser.role eq 'Admin' && ClientUser.access_level eq 1 }">
											<form method="post" role="form" modelAttribute="property" 
												enctype="multipart/form-data"
												action="<%=request.getContextPath() %>/lct/addProperty"
												id="property-form">
												<div class="row">
												    ...
												    <button type="button" onclick="addFileInput()">Add More Files</button><br><br>
										...
										<c:otherwise>
											<h4 class="text-danger mb-2">*You are not authorized to add property.</h4>
										</c:otherwise>
									</c:choose>
								</div>
							</div>
