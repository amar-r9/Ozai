                                    ...
                                    <c:forEach items="${userEmotions}" var="userEmotion">
                                        <tr>
                                            ...
                                            <td class="text-center">
												<c:choose>
													<c:when test="${userEmotion.emotion eq 'terrible'}">
														<i id="very_sad" class="bi-emoji-dizzy fa-3x text-warning "></i>
													</c:when>
													<c:when test="${userEmotion.emotion eq 'bad'}">
														<i id="sad" class="bi-emoji-frown fa-3x text-warning "></i>
													</c:when>
													<c:when test="${userEmotion.emotion eq 'ok'}">
														<i id="ok" class="bi-emoji-expressionless fa-3x text-warning "></i>
													</c:when>
													<c:when test="${userEmotion.emotion eq 'good'}">
														<i id="happy" class="bi-emoji-smile fa-3x text-warning "></i>
													</c:when>
													<c:when test="${userEmotion.emotion eq 'excellent'}">
														<i id="very_happy" class="bi-emoji-laughing fa-3x text-warning "></i>
													</c:when>
												</c:choose>
													<p class="text-uppercase mt-0 mb-0"><small>${userEmotion.emotion}</small></p></td>
