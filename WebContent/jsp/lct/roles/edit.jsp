			                  	...
			                  	<form action="#" method="get" role="form"
									id="user-form">
				                  	<div class="row">
										...
										<div class="col-12 mb-3">
											<div class="form-group">
												<label class="control-label">Status (${admin.active })</label>
										...
										<input type="hidden" name="premium" id="premium" value="${admin.premium }" />
										<input type="hidden" name="verificationToken" id="verificationToken" value="${admin.verificationToken }" />
									</div>
