									...
									<c:forEach items="${tenants}" var="tenant" varStatus="sno">
										<div class="row user-row card-body" style="
											...
											<div class="col-sm-3 col-3 col-md-3 col-lg-3">
												<div style="background: #39c5ae; border-radius: 50%; width: 50px;
											...
											<div class="col-sm-7 col-7 col-md-7 col-lg-7">
												...
												<small>													
													<c:choose>
														<c:when test="${tenant.active ne 1 && tenant.role eq null }">
															<i class="fas fa-ban"></i> &nbsp;Not approved.
														</c:when>
														<c:otherwise>
															<span class="text-warning"> <i class="fas fa-user"></i>&nbsp; ${tenant.role }</span>
														</c:otherwise>
													</c:choose>
											  	</small>
											</div>
										...
										<div class="row user-infos ${tenant.id }">
											<div
												...
												<div class="panel p-2">
													...
													<div class="panel-footer text-end" style="padding: 10px 10px;">													<c:if test="${ClientUser.access_level eq 1 }">
