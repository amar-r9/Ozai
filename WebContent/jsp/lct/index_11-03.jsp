				...
				<div class="">
					<div class="row">
								...
								<div class="row">
									<div class="col-3 mb-3 text-center">
										<a href="<%=request.getContextPath() %>/lct/residents/list">
											...
											<small
												style="font-family: monospace; color: #000; font-size: .775em;">Residents</small>
										</a>
									</div>
									<div class="col-3 mb-3 text-center">
										<a href="<%=request.getContextPath() %>/lct/expenses/list">
											...
											<small
												style="font-family: monospace; color: #000; font-size: .775em;">Expenses</small>
										</a>
									</div>
									<div class="col-3 mb-3 text-center">
										<a href="<%=request.getContextPath() %>/lct/properties/list">
											...
											<small
												style="font-family: monospace; color: #000; font-size: .775em;">Properties</small>
										</a>
									</div>
									<div class="col-3 mb-3 text-center">
										<a href="<%=request.getContextPath() %>/lct/events/updates">
											...
											<small
												style="font-family: monospace; color: #000; font-size: .775em;">Updates</small>
										</a>
									</div>
								</div>
							</div>
											...
											<div class="row text-center">
												<div class="col-sm-6 col-6">
													<a href="<%=request.getContextPath()%>/lct/events/updates"
														...
														class="fas fa-plus"></i></a> <br> <span style="font-family: monospace; color: #000;">Delivery</span>
												</div>
												<div class="col-sm-6 col-6">
													<a href="<%=request.getContextPath()%>/lct/events/daily-updates"
														class="btn btn-circle btn-lg btn-light-info"> <i
														class="fas fa-list"></i></a><br> <span style="font-family: monospace; color: #000;">Daily Updates</span>
												</div>
											</div>
										</div>
									<!-- 7. Stats card -->				
						...
						<div class="col-md-6 col-6 col-sm-12 col-12">
							...
							<div class="card bg-white" style="border-radius: 10px;">
				                <div class="card-body">
				                  	<h6 class="text-dark fw-bold text-start" style="font-family: monospace;">Send Updates</h6>
			        	...
			        	<div class="row">
							<h6 class="text-dark fw-bold text-start" style="font-family: monospace;">Events</h6>
							<div class="col-6">
					...
					<div class="row">						
						<div class="col-md-6 col-6 col-sm-12 col-12">
				        	<div class="card" style="border-radius: 10px;">
								<div class="card-body">
									<h6 class="text-dark fw-bold text-start" style="font-family: monospace;">Recent Tickets
										<span style="float: right;">
											<a href="<%=request.getContextPath() %>/lct/tickets/list">View all</a></span></h6>
						...
						<div class="col-lg-12 col-xl-6">
			              <div class="card">
			                <div class="border-bottom title-part-padding">
			                  <h6 class="text-dark fw-bold text-start" style="font-family: monospace;">Resident Breakup</h6>
			                </div>
												...
												<div class="row text-center">
													<div class="col-sm-4 col-4">
														<a
															...
															class="fas fa-plus"></i></a> <br> <span style="font-family: monospace; color: #000; font-size: .875em !important;">Add</span>
													</div>
													<div class="col-sm-4 col-4">
														<a href="<%=request.getContextPath()%>/lct/residents/list"
															class="btn btn-circle btn-lg btn-light"> <i
															class="fas fa-list"></i></a><br> <span style="font-family: monospace; color: #000; font-size: .875em !important;">List</span>
													</div>
													<div class="col-sm-4 col-4">
														<a
															href="<%=request.getContextPath()%>/lct/residents/pending-rents"
															class="btn btn-circle btn-lg btn-light"> <i
															class="fas fa-rupee-sign"></i></a><br> <span style="font-family: monospace; color: #000; font-size: .875em !important;">Pending Rents</span>
													</div>
												</div>
											</div>
										</div>
												...
												<div class="row text-center">
													<div class="col-sm-4 col-4">
														<a
															...
															style="font-family: monospace; color: #000;">Add</span>
													</div>
													<div class="col-sm-4 col-4">
														<a href="<%=request.getContextPath()%>/lct/properties/list"
															class="btn btn-circle btn-lg btn-light-primary"> <i
															class="fas fa-list"></i></a><br> <span
															style="font-family: monospace; color: #000;">List</span>
													</div>
													<div class="col-sm-4 col-4">
														<a
															...
															style="font-family: monospace; color: #000;">Worksites</span>
													</div>
												</div>
											</div>
										</div>
												...
												<div class="row text-center">
													...
													<div class="col-sm-4 col-4 ">
														<a href="<%=request.getContextPath()%>/lct/expenses/list"
															...
															class="fas fa-list"></i></a><br> <span
															style="font-family: monospace; color: #000;">Due List</span>
													</div>
													<div class="col-sm-4 col-4 ">
														<a
															...
															style="font-family: monospace; color: #000;">Vendors</span>
													</div>
													<%-- <div class="col-sm-4 col-4">
														<a
