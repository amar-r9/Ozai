        ...
        <nav class="navbar top-navbar navbar-expand-md navbar-dark">
          <div class="navbar-header" style="position: fixed;">
            ...
            <div class="navbar-brand">
              <a href="<%=request.getContextPath() %>/smartlife" class="logo">
                <!-- Logo icon -->
                <b class="logo-icon me-0 pe-0 ps-0 ms-0">
                  <!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->
                  <!-- Dark Logo icon -->
                  <img
                    src="<%=request.getContextPath()%>/assets/images/smartlife.png"
                    alt="homepage"
                    class="dark-logo"
                  />
                  <!-- Light Logo icon -->
            ...
            <div class="d-block d-sm-none">
	            <c:if test="${not empty SmartAdmin }">
					<a
						class="
	                    nav-link
	                    dropdown-toggle
						...
						aria-expanded="false"> <img
							...
							<span class="ms-1 font-weight-medium d-none d-sm-inline-block">${SmartAdmin.name }
						...
						<div class="dropdown-menu dropdown-menu-end user-dd animated flipInY">
							...
							<div class="d-flex no-block align-items-center p-3 bg-primary text-white mb-2">
								...
								<div class="ms-2">
									<h4 class="mb-0 text-white">${SmartAdmin.name }</h4>
							...
							<!-- <a class="dropdown-item" href="#"><i
								...
								Account Setting</a> -->
							<div class="dropdown-divider"></div>
							<a class="dropdown-item" href="<%=request.getContextPath()%>/smartlogout"><i
