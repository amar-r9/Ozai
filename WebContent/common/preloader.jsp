...
<style>
	...
	@media (min-width: 768px) and (max-width: 1024px) {
		/* Targeting iPad Pro width range */
		#main-wrapper[data-layout=vertical][data-sidebartype=mini-sidebar] .page-wrapper {
			margin-left: 30px !important;
			margin-right: 30px !important; /* Set margin-left to 0 for iPad Pro */
		}
	}
	/* Target iPad devices */
	@media (min-width: 768px) and (max-width: 1024px) {
		...
		#main-wrapper[data-layout=vertical][data-sidebartype=mini-sidebar] .topbar .top-navbar .navbar-header .navbar-brand {
			width: auto; /* Reset width to auto for iPad */
			justify-content: flex-start; /* Optionally reset justify-content */
		}
		.navbar-header {
